...
export default function MultiSelectDropdown({
  ...
  return (
    <label className="w-full relative">
      ...
      <div className="mb-6 my-2 focus:outline-none focus:border-blue-500 outline-none rounded-md w-full p-2 cursor-pointer after:content-['▼'] after:text-xs after:ml-10 after:inline-flex after:items-center peer-checked:after:-rotate-180 after:transition-transform inline-flex border px-5 py-2">
        {prompt}
